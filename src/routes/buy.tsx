    ...
    <WalletShell>
      <div className="p-4">
        ...
        <div className="rounded-2xl border bg-gradient-to-br from-accent/40 to-card p-8 text-center">
          ...
          <h2 className="mt-4 text-lg font-semibold">Sắp ra mắt</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Tích hợp on-ramp với MoonPay, Transak để mua crypto bằng thẻ ngân hàng sẽ có trong phiên bản tiếp theo.
          </p>
        </div>
      </div>
    </WalletShell>
